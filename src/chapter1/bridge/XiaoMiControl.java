...
public class XiaoMiControl extends AbstractAdjusterImpl<BaseDevice> {

    public XiaoMiControl(BaseDevice baseDevice, ControlTypeEnum controlTypeEnum, LightColorEnum lightColorEnum) {
